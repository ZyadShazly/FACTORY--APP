...
export const demoData = {
  ...
  assetCategories: [{id:"ac1",name:"كهرباء",is_active:true},{id:"ac2",name:"سلامة",is_active:true}], assetLocations:[{id:"al1",name:"المخزن الرئيسي",location_type:"warehouse",is_active:true}], assets:[],assetAssignments:[],assetAssignmentItems:[],assetReturnEvents:[],assetReturnItems:[],assetSettlements:[],assetMovements:[],assetAttachments:[],assetAlerts:[],
