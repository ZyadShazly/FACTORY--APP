...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 — Baseline stabilization | `agent/pilot-baseline-stabilization` | Pending | Validation complete; publish pending | Focused 9/9; full 291 passed, 0 failed, 2 skipped | Passed, 2,396 modules | Local passed; remote pending | Pending PR | None | GitHub-hosted run still required for upgraded actions | LF/CRLF idempotency; clean test/build tree; desktop/mobile/RTL smoke passed | None |
| 1 — Design system foundation | `agent/nextep-design-system-foundation` | Pending | Not started | Pending | Pending | Pending | Pending | None planned | Shared presentation files may overlap open UX work | Responsive RTL component contracts | Phase 0 PR must exist first |
| 2 — Procurement completion | `agent/procurement-pilot-completion` | Pending | Not started | Pending | Pending | Pending | Pending | Review required | Open PR #80 must be reused or reconciled without duplication | PR → approval → PO → receipt → invoice | PR #80 scope review |
...
- PR #80 (`agent/fix-procurement-print-templates`) is an open Draft PR and must be reviewed before Phase 2.
