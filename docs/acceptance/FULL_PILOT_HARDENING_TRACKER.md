...
| 3 — Inventory pilot hardening | `agent/inventory-pilot-hardening` | [Draft PR #87](https://github.com/ZyadShazly/FACTORY--APP/pull/87) | Open Draft; implementation and automated validation complete; stacked on Phase 2 | Focused 42/42; full 315 passed, 0 failed, 2 skipped | Passed, 2,398 modules | Passed | Passed | No migration or schema change | Recently merged Inventory UX and protected ledger/RPC contracts preserved | Bug A direct linking/refresh and Bug B opening-inventory contracts passed; live desktop/mobile RTL pending | None |
