...
`20260719111053_project_estimated_budget.sql` نفس الدالة لتجعل اعتماد الميزانية
...
تنفذ Migration `20260719111053_project_estimated_budget.sql` الميزانية التقديرية
