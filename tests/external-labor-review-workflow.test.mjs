...
const migration = fs.readFileSync("supabase/migrations/20260721151650_external_labor_review_workflow.sql", "utf8");
const fix = fs.readFileSync("supabase/migrations/20260721161457_external_labor_payment_parameter_fix.sql", "utf8");
const settlement = fs.readFileSync("supabase/migrations/20260802122437_external_labor_settlement.sql", "utf8");
const correction = fs.readFileSync("supabase/migrations/20260803053721_daily_labor_correction_archive.sql", "utf8");
const correctionIndexes = fs.readFileSync("supabase/migrations/20260803054154_daily_labor_correction_indexes.sql", "utf8");
