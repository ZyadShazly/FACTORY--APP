...
const migrationPath = "supabase/migrations/20260728000300_employee_lifecycle_completion.sql";
const migration = fs.readFileSync(migrationPath, "utf8");
const employeeWorkflow = fs.readFileSync("supabase/migrations/20260721095523_employee_management_workflow.sql", "utf8");
const employeeDeleteGuard = fs.readFileSync("supabase/migrations/20260721095949_employee_delete_guard_reconcile.sql", "utf8");
const projectIndexes = fs.readFileSync("supabase/migrations/20260719000200_project_workspace_performance_hardening.sql", "utf8");
const assetIndexes = fs.readFileSync("supabase/migrations/20260718000800_assets_security_performance_hardening.sql", "utf8");
const productionCompletion = fs.readFileSync("supabase/migrations/20260728000100_production_pilot_completion.sql", "utf8");
const identityBinding = fs.readFileSync("supabase/migrations/20260718000700_bind_asset_employee_profile_identity.sql", "utf8");
const payrollFoundation = fs.readFileSync("supabase/migrations/20260713000100_v2_2_projects_payroll.sql", "utf8");
...
test("every dependency lookup has an existing or newly added covering index", () => {
  ...
  assert.match(payrollFoundation + fs.readFileSync("supabase/migrations/20260719000100_project_workspace_upgrade.sql", "utf8"), /project_milestones_responsible_employee_idx[\s\S]*project_milestones\(responsible_employee_id\)/i);
